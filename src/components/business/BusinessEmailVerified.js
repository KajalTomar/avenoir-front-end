...
class BusinessEmailVerified extends React.Component{
    constructor(props){
        super(props)
        this.state = {
	...
	componentDidMount(){
        ...
        fetch(`https://authentic-uoft.herokuapp.com/auth/business/verifyemail?id=${token}`, {
            method: 'POST',
            headers: {
...
export default BusinessEmailVerified;