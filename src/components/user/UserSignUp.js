...
//   }, [values.latitude, values.longitude])
  ...
  const submitHandler = () => {
    ...
    // ..... lot of validation ....
    if(validated){
        fetch('https://authentic-uoft.herokuapp.com/auth/user/signup', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            if(data.error){
                setValues(oldValues => ({...oldValues, error: JSON.stringify(data.error) }));
            } else {
                setValues(oldValues => ({...oldValues, success: data.message }));
            }
        })
        .catch(err => {
  ...
  return (
   //padding around size 4, color black-80 used for everything in the user signup
    <div className='bg-washed-yellow'>
      <DefaultNavigation/>
      <div  className="pa4-ns ba-ns ma6-ns ma3-m pa2-m pa1 black-60 tc"  style={{backgroundImage: `url(${photo})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
        <p className="f-subheadline-ns light-red f3 f2-m">USER SIGN UP</p>
        <form>
              ...
              <div className="mt3">                                                                                          
                ...
                <input className="pa2 input-reset br4 ba bg-transparent hover-bg-white w-40 measure" type="text" name="name" id="name"  required="required" value={values.name} onChange={set('name')}/>
              <p style={{color: 'red'}}>{values.nameError}</p>
                ...
                <div className="mt3">
                  ...
                  <input value={values.email} onChange={set('email')} className="pa2 br4 input-reset ba bg-transparent hover-bg-white w-40 measure" type="email" name="email-address" id="email-address"  required="required"/>
                ...
                <div className="mt3">
                  ...
                  <input value={values.password} onChange={set('password')} className="pa2 br4 input-reset ba bg-transparent hover-bg-white w-40 measure" type="password" name="password" id="password"  required="required"/>
                ...
                <div className="mt3">
                  ...
                  <input value={values.password2} onChange={set('password2')} className="pa2 br4 input-reset ba bg-transparent hover-bg-white w-40 measure" type="password" name="password2" id="password2"  required="required"/>
                ...
                <div className="mt3">
                  ...
                  <input value={values.phone} onChange={set('phone')} className="pa2 input-reset br4 ba bg-transparent hover-bg-white w-40 measure" type="tel" name="phoneNumber" id="phoneNumber"  required="required"/>
                ...
                <div className="mt3">
                  ...
                  <input value={values.street} onChange={set('street')} className="pa2 br4 input-reset ba bg-transparent hover-bg-white w-40 measure" type="text" name="street" id="street"  required="required"/>
              ...
              <div className = "flex items-center justify-center">
                ...
                <div className="mt3 pa3 ph4">
                  ...
                  <input value={values.city} onChange={set('city')} className="pv2 br4 input-reset ba bg-transparent hover-bg-white w-100" type="text" name="City" id="City"  required="required"/>
                  <p style={{color: 'red'}}>{values.cityError}</p>
                </div>
                {/* this is the postal field */}
                <div className="mt3 pa3 ph4">
                  <label className="db fw4 lh-copy f6" htmlFor="City">Postal*</label>
                  <input value={values.postal} onChange={set('postal')} className="pv2 br4 input-reset ba bg-transparent hover-bg-white w-100" type="text" name="Postal" id="Postal"  required="required"/>
              ...
              <div className="f1-ns f5 f3-m">
                ...
                <div className="mt3">
                  ...
                  <input value={values.cc} onChange={set('cc')} className="pa2 input-reset br4 ba bg-transparent hover-bg-white w-40 measure" type="text" name="ccNumber" id="ccNumber"  required="required"/>
              ...
              <div className = "center justify-center">
                ...
                <div>
                  ...
                  <input value={values.exp} onChange={set('exp')} className="pa2 br4 input-reset ba bg-transparent hover-bg-white w-30 w-10-ns measure" type="text" name="expirationDate" id="expirationDate"  required="required" placeholder="MM/YYYY"/>
                  <p style={{color: 'red'}}>{values.expError}</p>
                </div>
                {/* this is the cvv field*/}
                <div className="mt3">
                  <label className="db fw4 lh-copy f6" htmlFor="cvv">CVV*</label>
                  <input value={values.cvv} onChange={set('cvv')} className="pa2 br4 input-reset ba bg-transparent hover-bg-white w-20 w-10-ns measure" type="text" name="cvv" id="cvv"  required="required"/>
                  <p style={{color: 'red'}}>{values.cvvError}</p>
                </div>
              </div>
            
                  {/*this is the submit button */}
              <div className="mt3"><input className="b ph3 pv2 br4 input-reset ba b--black bg-lightblue hover-bg-white grow pointer f6 w-15 measure black" type="button" onClick={submitHandler} defaultValue="Sign Up" /></div>
            </form>

                <p style={{color: values.success ? 'green' : 'red'}}>{values.success ? values.success : values.error}</p>

            <a href="/user/login" className="pa2 f6 link dim black db">Already have an account? Sign in</a>   
      </div>
  </div>
  )//return
